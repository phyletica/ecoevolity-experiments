...
\newcommand{\validationfiguregriddescription}{The first four columns show the
    ...
    ($\epopsize{}\murate{}$) of all populations are fixed to 0.002.
...
\newcommand{\accuracyscatterplotannotations}[1]{For each plot, the
    root-mean-square error (RMSE) and the proportion of divergence-time
    estimates for which the 95\% posterior credibility interval contained the
    true divergence time---$p(#1 \in \textrm{CI})$---is given.
}
