\mFigure{../../simulations/validation/plots/div-time-scatter.pdf}{
    ...
    \textrm{CI})$---is given.
    We generated the plot using matplotlib Version 2.0.0 \citep{matplotlib}.
}{fig:valdivtimes}
...
\mFigure{../../gekko-results/sumevents.pdf}{
    ...
    We generated the plots with ggplot2 Version 2.2.1 \citep{ggplot2}.
}{fig:gekkonevents}
...
\mFigure{../../gekko-results/sumtimes.pdf}{
    ...
    under eight different combinations of priors on the divergence times (rows)
    and the concentration parameter of the Dirichlet process (columns).
    We generated the plots with ggridges Version 0.4.1 \citep{ggridges041} and
    ggplot2 Version 2.2.1 \citep{ggplot2}.
}{fig:gekkodivtimes}
