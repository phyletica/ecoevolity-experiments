% TODO:
% - PRSF plots need separate X-axis scales.
% - Perform correlation (r, p = scipy.stats.pearsonr(x,y)) on ESS vs Error.
...
the relative size of the root population was distributed as \dgamma{100}{1}.
