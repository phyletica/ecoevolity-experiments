...
As expected, the precision of divergence time and population size estimates
...
(Figures S\labelcref{fig:linkageleafsizes100k, fig:linkageleafsizes500k,
    fig:linkagerootsizes100k, fig:linkagerootsizes500k}).
...
variability of these data (Table~\ref{tab:gekkoData}), and other data from
these species \citep{Siler2012, Siler2014kikuchii}, these values are clearly
nonsensical.
...
(Figures
S\labelref{fig:gekkonopolyvaronlydivtimes,fig:gekkonopolyvaronlysizes,fig:gekkonopolyvaronlynevents}).
