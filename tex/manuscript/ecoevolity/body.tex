...
loci from three of the pairs of \emph{Gekko} populations.
...
effective size of the ancestral population, which was \dgamma{5}{0.002}.
...
(Figure \ref{fig:gekkobakeoff} A \& B).
...
(Figure \ref{fig:gekkobakeoff} C \& D).
