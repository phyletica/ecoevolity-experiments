...
(Fig.~\labelcref{fig:divCartoon,fig:dag}),
...
% to the former.
For \dppmsbayes,
we placed a distribution of \dgamma{5}{0.008} on $4\epopsize{}\murate{}$
for the ancestral and both descendant populations of each pair.
Accordingly, for \ecoevolity, we used a distribution of \dgamma{5}{0.002} on
