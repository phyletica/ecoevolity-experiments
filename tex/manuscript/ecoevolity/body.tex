...
the probability of the observed data at a locus (\allelecount and
\redallelecount), is the probability of the site pattern given the gene tree
multiplied by the probability of the gene given the species tree, summed over
all possible gene tree topologies and integrated over all possible gene tree
branch lengths,
\begin{equation}
...
likelihood of the species tree directly from a biallelic site pattern under
a coalescent model.
...
variable loci for each population (i.e., no missing locus copies), but will
...
For the \datasets simulated with 100,000 and 500,000 characters,
