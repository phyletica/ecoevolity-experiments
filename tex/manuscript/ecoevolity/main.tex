...
\newcommand{\mytitle}{Full Bayesian Comparative Phylogeography from Genomic Data}
\newcommand{\myrunninghead}{\uppercase{Full Bayesian comparative phylogeography}}
