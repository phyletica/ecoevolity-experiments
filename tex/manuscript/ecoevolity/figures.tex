\mFigure{../../images/div-cartoon/div-cartoon.pdf}{
    ...
    fragmented into two islands by a rise in sea levels.
    The island fragmentation caused the second and third (from the top) lizard
    lineages to co-diverge; the first lineage diverged later via over-water
    dispersal.
    ...
    are shown.
    The third lizard lineage shows the notation for the effective size of the
    ancestral (\epopsize[\rootpopindex{}]) and descendant
    (\epopsize[\descendantpopindex{}] and \epopsize[\descendantpopindex{}])
    populations.
}{fig:divCartoon}
